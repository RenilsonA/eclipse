...
public class Listar {
	...
	public void initialize() {
		 ...
		 * String[] { "Nomes", "Atributo", "Remuneração" } ));
		 */
			/*
			 * table.setModel(new DefaultTableModel( new Object[][] { for(int i = 0; i <
			 * list.funcionarios.size(); i++) { Object linha[] = new
			 * Object[]{list.funcionarios.get(i).getNome()};
			 * 
			 * } }, new String[] { "Nomes", "Atributo", "Remuneração" } ));
			 */
	...
	public void tabela() {
		list.printa();
		DefaultTableModel modelo = new DefaultTableModel(new Object[] {  "ID", "Nomes", "Atributo"}, 0);
		for (int i = 0; i < list.funcionarios.size(); i++) {
			Object linha[] = new Object[] {list.funcionarios.get(i).getID(), list.funcionarios.get(i).getNome(), list.funcionarios.get(i).getAtributo()};
			modelo.addRow(linha);
		}
