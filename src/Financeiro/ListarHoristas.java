	...
	public void Initialize() {
		...
		btnModificarFuncionrios.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(Listas.horistas.size() > 0 && !ModificacaodeID.getText().isEmpty()) {
					...
					for(int a = 0; a < f.length(); a++) {
						...
						int posicao = posic.posicao(1, Integer.parseInt(x));
						if(posicao >= 0) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < Listas.horistas.size(); i++) {
					Object linha[] = new Object[] {Listas.horistas.get(i).getID(), Listas.horistas.get(i).getNome(), 
												   Listas.horistas.get(i).getSalarioHora(), Listas.horistas.get(i).getBonus(), 
												   Listas.horistas.get(i).getGrupo()};
					modelo.addRow(linha);
