	...
	private void Initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DefaultTableModel modelo = new DefaultTableModel(new Object[] { "ID", "Nome", "Venda", "Dia"}, 0);
				Object linha0[] = new Object[] {"ID", "Nome", "Venda", "Dia"};
				...
				Lista li = new Lista();
				for (int i = 0; i < Listas.vendas.size(); i++) {
					Object linha[] = new Object[] {Listas.vendas.get(i).getID(), Lista.funcionarios.get(li.posicao(Listas.vendas.get(i).getID())).getNome(), 
												   Listas.vendas.get(i).getVenda(), Listas.vendas.get(i).getDiadaVenda()};
					modelo.addRow(linha);
